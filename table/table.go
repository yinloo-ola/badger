...
// OnDiskSize returns the total size of key-values stored in this table
// (including the disk space occupied on the value log).
func (t *Table) OnDiskSize() uint32 { return t.cheapIndex().OnDiskSize }

// DataKey returns the encryption key
